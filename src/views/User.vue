  ...
  <div class="container py-5">
    ...
    <div class="row">
      <div class="col-md-4">
        ...
        <!-- UserFollowersCard -->
        <UserFollowsCard :followers="followers" />
      </div>
      <div class="col-md-8">
        <!-- UserCommentsCard -->
        <UserCommentsCard :comments="comments" />
        <!-- UserFavoritedRestaurantsCard -->
        <UserFavaritedRestaurantsCard :favorited-restaurants="favoritedRestaurants" />
      </div>
    </div>
  </div>
</template>
...
import UserFavaritedRestaurantsCard from './../components/UserFavaritedRestaurantsCard'
const dummyData = {
  'profile': {
    'id': 1,
    'name': 'root',
